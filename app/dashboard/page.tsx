                    ...
                    <div className="bg-white rounded-lg border border-gray-200 p-6">
                        ...
                        <div className="grid grid-cols-3 gap-6">
                            ...
                            <div className="text-center">
                                ...
                                <div className="text-sm text-gray-600">Total Low Stock</div>
                                <div className="flex items-center justify-center mt-1">
                                    <span className="text-xs text-green-600">
                                        +{lowStock}
                                    </span>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
                            ...
                            {recent.map((product, key) => {
                                ...
                                return (
                                    <div key={key} className="flex items-center justify-between p-3 rounded-lg bg-gray-50">
                                        ...
                                        <div className={`
                                            text-sm font-medium ${textColors[stockLevel]}`}>{product.quantity} units</div>
                                    </div>
                                )
                            })}
                        </div>
                    ...
                    <div className="bg-white rounded-lg border border-gray-200 p-6">
                        ...
                        <div className="flex items-center justify-center">
                            <div className="relative w-48 h-48">
                                ...
                                <div className="absolute inset-0 rounded-full border-8 border-purple-600"
                                    style={{
                                        clipPath: "polygon(50% 50%, 50% 0%, 100% 0%, 100% 100%, 0% 100%, 50% 0)",
                                    }}>
                        ...
                        <div className="mt-6 space-y-2">
                            ...
                            <div className="flex items-center-safe justify-between text-sm text-gray-600">
                                <div className="flex items-center space-x-2">
